...
// Wordpress Calculated Fields constants and global variables
...
// Admin pages
define('CP_CALCULATED_FIELDS_SETTINGS_PAGE',  'cp_wp_calculated_fields');
define('CP_CALCULATED_FIELDS_SETTINGS_PAGE2', 'cp_wp_calculated_fields_sub2');
define('CP_CALCULATED_FIELDS_SETTINGS_PAGE3', 'cp_wp_calculated_fields_sub3');
...
global $wpdb;
define('CP_CALCULATEDFIELDSF_FORMS_TABLE', 'cp_wp_calculated_fields_settings');
define('CP_CALCULATEDFIELDSF_FORMS_REVISIONS_TABLE', 'cp_wp_calculated_fields_revision');
define('CP_CALCULATEDFIELDSF_DISCOUNT_CODES_TABLE_NAME_NO_PREFIX', "cp_wp_calculated_fields_discount_codes");
define('CP_CALCULATEDFIELDSF_DISCOUNT_CODES_TABLE_NAME', @$wpdb->prefix ."cp_wp_calculated_fields_discount_codes");
define('CP_CALCULATEDFIELDSF_POSTS_TABLE_NAME_NO_PREFIX', "cp_wp_calculated_fields_posts");
define('CP_CALCULATEDFIELDSF_POSTS_TABLE_NAME', @$wpdb->prefix ."cp_wp_calculated_fields_posts");
