...
Wordpress Calculated Fields is a plugin for creating forms with dynamically calculated fields and display the result.

== Description ==

Wordpress Calculated Fields is for visually:
...
With Wordpress Calculated Fields you can create **forms with dynamically calculated fields** to **display the calculated values**.
...
Wordpress Calculated Fields can be used for creating both single and complex calculations, for example general calculators, ideal weight calculators, calorie calculators, calculate quotes for hotel booking and rent a car services, calculate quotes for appointments and services, loan & finance calculators, date calculators like pregnancy calculators, etc...
...
The "Wordpress Calculated Fields" plugin allows the specific integration with the following editors:
...
The CSS classes/rules can be placed into the file "wp-content\plugins\wp-calculated-fields\css\stylepublic.css" or into your theme CSS files.
...
= Fields available in the Wordpress Calculated Fields's form builder =
...
The developer and platinum versions of the plugin include the WooCommerce add-on, to integrate the forms created by the "Wordpress Calculated Fields" with the WooCommerce products.
...
The Platinum version of the plugin includes the Easy Digital Downloads add-on, to integrate the forms created by the "Wordpress Calculated Fields" with the EDD products.
...
The add on integrates the Wordpress Calculated Fields with the ip2location databases to identify additional information of users based on their IP, as: Country, City Name, Coordinates, Weather Station, Time Zone, ZIP Code, etc...
...
To install Wordpress Calculated Fields, follow these steps:

1.	Download and unzip the Wordpress Calculated Fields plugin
2.	Upload the entire wp-calculated-fields/ directory to the /wp-content/plugins/ directory
3.	Activate the Wordpress Calculated Fields plugin through the Plugins menu in WordPress
4.	Configure the settings at the administration menu >> Settings >> Wordpress Calculated Fields
...
= Q: Is the "Wordpress Calculated Fields" plugin compatible with "Autoptimize"? =

A: [Yes, both plugins are compatible...](http://cff.dwbooster.com/faq#q214 "Yes, both plugins are compatible...")

= Q: Is the "Wordpress Calculated Fields" plugin compatible with "Plugin Organizer"? =

A: [Yes, both plugins are compatible...](http://cff.dwbooster.com/faq#q319 "Yes, both plugins are compatible...")

= Q: What means each field in the Wordpress Calculated Fields settings area? =

A: The Wordpress Calculated Fields's page contains detailed information about each field in the plugin:

[Form Fields](https://cff.dwbooster.com/documentation#common-fields "Form fields")

= Q: Where can I publish a Wordpress Calculated Fields? =
